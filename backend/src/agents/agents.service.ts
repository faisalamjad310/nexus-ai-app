...
export class AgentsService {
  ...
  async run(id: string, message: string, userId: string | null) {
    ...
    const response = this.buildAgentResponse(message, agent, model, tools);
    return {
      agentId: id,
