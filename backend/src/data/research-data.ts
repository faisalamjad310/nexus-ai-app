...
export const RESEARCH: ResearchEntry[] = [
  ...
  },
  {
    ...
    citation:
      'Meta GenAI (2026). Llama 4 Scout & Maverick Technical Overview. Meta AI Research.',
  },
  {
  ...
  },
  {
    ...
    citation:
      'DeepSeek-AI (2026). DeepSeek-R1 Open Release Notes. deepseek.com.',
  },
  {
    ...
    citation:
      'OpenAI (2026). GPT-5.4 Enterprise Evaluation Summary. OpenAI Systems.',
  },
  {
    ...
    summary:
      'New benchmark results show Devstral 2 outperforms all open-source models on SWE-bench verified.',
    category: 'CODE',
