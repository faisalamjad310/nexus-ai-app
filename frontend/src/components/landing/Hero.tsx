...
export default function Hero() {
  ...
  const handleSearch = () => {
    if (query.trim()) {
      dispatch(addMessage({ id: Date.now().toString(), role: 'user', content: query, timestamp: Date.now() }));
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="flex items-center min-h-[52px] sm:min-h-[58px]">
            ...
            <div className="hidden sm:flex items-center gap-0.5 px-1.5 flex-shrink-0">
              <button className="w-[34px] h-[34px] rounded-full flex items-center justify-center text-text3 hover:bg-bg2 hover:text-text1 transition-all">
                <FiMic size={17} />
              </button>
              <button className="w-[34px] h-[34px] rounded-full flex items-center justify-center text-text3 hover:bg-bg2 hover:text-text1 transition-all">
                <FiUpload size={17} />
