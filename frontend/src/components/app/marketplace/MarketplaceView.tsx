...
export default function MarketplaceView() {
  ...
  const { searchQuery, activeFilter, activeLab, priceRange, minRating } = useSelector((s: RootState) => s.models);
  ...
  }), [searchQuery, activeFilter, activeLab, priceRange, minRating]);
          ...
          <div>
            ...
            <div className="flex flex-col gap-1">
              {[
                ...
                <button key={g.label}
                  onClick={() => { const m = MODELS[0]; dispatch(openModal({ model: m, tab: g.tab })); }}
